"""
This Named Entity recognition model is trained on the Gronigen Meaning Bank Version 2
It also extends nltk's ChunkParser to make it very easy to train with nltk
"""
...
corpus_root = os.path.join(abs_dir, "data", "ner", "gmb-2.2.0")  # Make sureto unzip into data folder
            ...
            if filename.endswith(".tags"):
                with open(os.path.join(root, filename), 'rb') as file_handle:
                    ...
                    for annotated_sentence in annotated_sentences:
                        ...
                        for _, annotated_token in enumerate(annotated_tokens):
